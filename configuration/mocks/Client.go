...
// PutConfigurationToml provides a mock function with given fields: _a0, overwrite
func (_m *Client) PutConfigurationToml(_a0 *toml.Tree, overwrite bool) error {
	ret := _m.Called(_a0, overwrite)

	var r0 error
	if rf, ok := ret.Get(0).(func(*toml.Tree, bool) error); ok {
		r0 = rf(_a0, overwrite)
	} else {
		r0 = ret.Error(0)
	}
